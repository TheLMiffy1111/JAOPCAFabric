...
public class DynamicSpecConfigImpl extends CommentedConfigWrapper<CommentedConfig> implements DynamicSpecConfig {

	final CommentedConfig config;

	public DynamicSpecConfigImpl(CommentedConfig config) {
		super(config);
		this.config = config;
