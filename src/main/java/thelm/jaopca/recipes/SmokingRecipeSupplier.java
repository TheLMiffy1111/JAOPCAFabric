...
public class SmokingRecipeSupplier implements Supplier<SmokingRecipe> {
	...
	public SmokingRecipeSupplier(Identifier key, Object input, Object output, int count, float experience, int time) {
		this(key, "", input, output, count, experience, time);
	}

	public SmokingRecipeSupplier(Identifier key, String group, Object input, Object output, int count, float experience, int time) {
